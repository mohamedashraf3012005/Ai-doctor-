  ...
  void _triggerAnalysis() {
    ...
    if (authState is! AuthAuthenticated) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(context.translate('signInToRunDiagnosis')),
                      ...
                      child: Column(
                        ...
                        children: [
                          if (state is DiagnosisInitial || state is DiagnosisError) ...[
                            // Step 1: Selection
                            Text(
                              context.translate('selectExaminationType'),
                            ...
                            Text(
                              context.translate('aiModelsTrainedHint'),
                              style: const TextStyle(
                                fontSize: 13,
                            ...
                            if (_filePath != null && state is! DiagnosisLoading)
                              Center(
                                child: AppButton(
                                  label: context.translate('analyzeWithAi'),
                                  icon: Icons.biotech,
                            ...
                            Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text(
                                    context.translate('detectingAnomaliesHint'),
                                    style: const TextStyle(
                                      fontSize: 13,
                                      color: AppColors.textSecondary,
                                    ),
                          ...
                          if (state is DiagnosisSuccess) ...[
                            Center(
                              child: Text(
                                context.translate('analysisResults'),
                                style: const TextStyle(
                                  fontSize: 24,
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      context.translate('aiDisclaimer'),
                                      style: TextStyle(
                                        fontSize: 12,
