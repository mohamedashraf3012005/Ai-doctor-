...
class AppStrings {
  ...
  static const Map<String, Map<String, String>> _translations = {
    ...
    'registeredDoctors': {'en': 'Registered Doctors', 'ar': 'الأطباء المسجلين'},

    'todayAppointments': {'en': "Today's Appointments", 'ar': 'مواعيد اليوم'},
    'pendingVerification': {'en': 'Pending Verification', 'ar': 'في انتظار التوثيق'},
    'apptsThisMonth': {'en': 'Appts This Month', 'ar': 'مواعيد هذا الشهر'},
    'quickReport': {'en': 'Quick Report', 'ar': 'تقرير سريع'},
    'platformGrowth': {'en': 'Platform Growth (Patients vs Doctors)', 'ar': 'نمو المنصة (المرضى مقابل الأطباء)'},
    'doctorsBySpecialty': {'en': 'Doctors by Specialty', 'ar': 'الأطباء حسب التخصص'},
    'patientGender': {'en': 'Patient Gender', 'ar': 'جنس المرضى'},
    'appointmentStatus': {'en': 'Appointment Status', 'ar': 'حالة المواعيد'},
    'weeklyAppointments': {'en': 'Weekly Appointments', 'ar': 'مواعيد الأسبوع'},
    'recentSystemActivity': {'en': 'Recent System Activity', 'ar': 'أحدث نشاطات النظام'},
    'patientsDirectory': {'en': 'Patients Directory', 'ar': 'دليل المرضى'},
    'doctorsVerification': {'en': 'Doctors Verification', 'ar': 'توثيق الأطباء'},
    'allAppointments': {'en': 'All Appointments', 'ar': 'كل المواعيد'},

    'allStatus': {'en': 'All Status', 'ar': 'كل الحالات'},
    'allDoctors': {'en': 'All Doctors', 'ar': 'كل الأطباء'},
    'verify': {'en': 'Verify', 'ar': 'توثيق'},
    'revoke': {'en': 'Revoke', 'ar': 'إلغاء التوثيق'},
    'verified': {'en': 'Verified', 'ar': 'موثق'},
    'pendingApproval': {'en': 'Pending Approval', 'ar': 'قيد الانتظار'},
    'activePatients': {'en': 'Active Patients', 'ar': 'مرضى نشطين'},
    'activeDoctors': {'en': 'Active Doctors', 'ar': 'أطباء نشطين'},
    'addSpecialty': {'en': 'Add Specialty', 'ar': 'إضافة تخصص'},
    'addPatient': {'en': 'Add Patient', 'ar': 'إضافة مريض'},
    'addNewSpecialty': {'en': 'Add New Specialty', 'ar': 'إضافة تخصص جديد'},
    'specialtyNameEn': {'en': 'Specialty Name (English)', 'ar': 'اسم التخصص (بالإنجليزية)'},
    'specialtyNameAr': {'en': 'Specialty Name (Arabic)', 'ar': 'اسم التخصص (بالعربية)'},
    'registerNewPatient': {'en': 'Register New Patient', 'ar': 'تسجيل مريض جديد'},
    'registerNewDoctor': {'en': 'Register New Doctor', 'ar': 'تسجيل طبيب جديد'},
    'medicalHistory': {'en': 'Medical History', 'ar': 'التاريخ الطبي'},
    'idCard': {'en': 'ID Card', 'ar': 'بطاقة الهوية'},
    'approve': {'en': 'Approve', 'ar': 'موافقة'},
    'reject': {'en': 'Reject', 'ar': 'رفض'},
    'rejectionReason': {'en': 'Rejection Reason', 'ar': 'سبب الرفض'},
    'rejectionReasonRequired': {'en': 'Please enter a reason for rejection.', 'ar': 'يرجى إدخال سبب الرفض.'},
    'tblUser': {'en': 'User', 'ar': 'المستخدم'},
    'tblAction': {'en': 'Action', 'ar': 'الإجراء'},
    'tblStatus': {'en': 'Status', 'ar': 'الحالة'},
    'tblTime': {'en': 'Time', 'ar': 'الوقت'},
    'confirmDeletion': {'en': 'Confirm Deletion', 'ar': 'تأكيد الحذف'},
    'confirmDeletionMsg': {'en': 'This action cannot be undone. Are you sure?', 'ar': 'لا يمكن التراجع عن هذا الإجراء. هل أنت متأكد؟'},
    'delete': {'en': 'Delete', 'ar': 'حذف'},
    'search': {'en': 'Search...', 'ar': 'بحث...'},
    'csvExport': {'en': 'CSV', 'ar': 'تصدير CSV'},
    'thPatientInfo': {'en': 'Patient Info', 'ar': 'معلومات المريض'},
    ...
    'thDoctorName': {'en': 'Doctor Name', 'ar': 'اسم الطبيب'},
    'thSpecialty': {'en': 'Specialty', 'ar': 'التخصص'},
    'thClinicAddress': {'en': 'Clinic Address', 'ar': 'عنوان العيادة'},
    'thExperience': {'en': 'Experience', 'ar': 'الخبرة'},
    'thVerification': {'en': 'Verification', 'ar': 'التوثيق'},
    'thPatient': {'en': 'Patient', 'ar': 'المريض'},
    'thDoctor': {'en': 'Doctor', 'ar': 'الطبيب'},
    'thDate': {'en': 'Date', 'ar': 'التاريخ'},
    'thTime': {'en': 'Time', 'ar': 'الوقت'},
    'doctorPortal': {'en': 'Doctor Portal', 'ar': 'بوابة الطبيب'},
    'weeklyPatientActivity': {'en': 'Weekly Patient Activity', 'ar': 'نشاط المرضى الأسبوعي'},
    'scanOverview': {'en': 'Scan Overview', 'ar': 'نظرة عامة على الفحوصات'},
    'normal': {'en': 'Normal', 'ar': 'طبيعي'},
    'warning': {'en': 'Warning', 'ar': 'تحذير'},
    'critical': {'en': 'Critical', 'ar': 'حرج'},
    'totalScans': {'en': 'Total Scans', 'ar': 'إجمالي الفحوصات'},
    'upcomingSchedule': {'en': 'Upcoming Schedule', 'ar': 'الجدول القادم'},
    'noUpcomingAppointments': {'en': 'No upcoming appointments scheduled', 'ar': 'لا توجد مواعيد قادمة مجدولة'},
    'bookingHistory': {'en': 'Booking History', 'ar': 'سجل الحجوزات السابقة'},
    'noPastBookings': {'en': 'No past bookings recorded', 'ar': 'لا توجد حجوزات سابقة مسجلة'},
    'confirm': {'en': 'Confirm', 'ar': 'تأكيد'},
    'complete': {'en': 'Complete', 'ar': 'إكمال'},
    'cancelAppointment': {'en': 'Cancel Appointment', 'ar': 'إلغاء الموعد'},
    'confirmCancelMsg': {'en': 'Are you sure you want to cancel the appointment with', 'ar': 'هل أنت متأكد من إلغاء الموعد مع'},
    'searchPatients': {'en': 'Search patients...', 'ar': 'ابحث عن المرضى...'},
    'noResults': {'en': 'No results found', 'ar': 'لا توجد نتائج'},
    'viewDetails': {'en': 'View Details', 'ar': 'عرض التفاصيل'},
    'scansAndAnalyses': {'en': 'Scans & AI Analyses', 'ar': 'الفحوصات وتحليلات الذكاء الاصطناعي'},
    'pendingReports': {'en': 'Pending Reports', 'ar': 'التقارير المعلقة'},

    'aiResult': {'en': 'AI Result', 'ar': 'نتيجة الذكاء الاصطناعي'},
    'review': {'en': 'Review', 'ar': 'مراجعة'},
    'manageHours': {'en': 'Manage Working Hours', 'ar': 'إدارة ساعات العمل'},
    'editProfile': {'en': 'Edit Profile', 'ar': 'تعديل البيانات'},
    'experienceYears': {'en': 'Years of Experience', 'ar': 'سنوات الخبرة'},
    'profileUpdated': {'en': 'Profile updated successfully!', 'ar': 'تم تحديث البيانات بنجاح!'},
